...
//	Ahora la funcion iniciar de la estructura es el constructor. 
	agrupacion_estatica() 
	    //Invoca a los constructores de los miembros privados (o deja
...
//	La funcion anyadir ahora es el metodo anyadir.Para acceder a atributos
...
//La funcion borrarUltimo se transforma tambien en un metodo. 
	bool borrarUltimo()
	{
	...
	//	en la misma función.
		...
		const_iterator& operator++()   
	       	{ 	
				//Rellena este hueco para que el iterador sobre la agrupación avance. Recuerda
				this->i--;
		...
		{
			//Rellena este método para que devuelva el elemento T al que está apuntando el iterador.
